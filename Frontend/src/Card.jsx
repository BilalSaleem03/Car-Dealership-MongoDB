                ...
                <div className="card-content">
                    ...
                    <div className="features-list">
                        <div className="feature-item">
                            <Car size={16} />
                            <span>Manufacturer: {car.Manufacturer || 'N/A'}</span>
                        </div>
                        
                        <div className="feature-item">
                            <Palette size={16} />
                            <span>Colour: {car.Color || 'N/A'}</span>
                        </div>
                        ...
                        <div className="feature-item">
                            <Tag size={16} />
                            <span>Car Type: {car.Car_Type || 'N/A'}</span>
                        </div>
                        
                        <div className="feature-item">
                            <Fuel size={16} />
                            <span>Engine: {car.Engine_Type || 'N/A'}</span>
                        </div>
                        
                        <div className="feature-item">
                            <User size={16} />
                            <span>Posted by: {car.Car_Owner || 'N/A'}</span>
                        </div>
                    </div>

                    {/* Price (if not showing as badge) */}
                    {!isGridView && car.Price && (
